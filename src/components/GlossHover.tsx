...
const GlossHover = ({
  ...
  return (
    ...
    >
      <div>
        <h2 className="relative left-5 top-9 text-right text-ink dark:text-white [text-shadow:2px_2px_0_rgb(233,241,247)] dark:[text-shadow:1px_1px_0_rgba(0,0,0,0.7)] font-semibold z-20 drop-shadow-lg">
          <sup>#</sup>
        ...
        <div
          ...
          className="relative group w-full md:w-[610px] lg:w-[420px] h-auto lg:h-[305px] rounded-2xl overflow-hidden hover:scale-[1.02] transition-transform duration-500 ease-in-out cursor-pointer border border-ink/10 shadow-sm"
        >
          <div
